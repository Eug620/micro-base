 ...
 * @Date         : 2023-08-14 15:45:08
 * @LastEditors  : eug yyh3531@163.com
 * @LastEditTime : 2024-04-22 18:24:35
 * @FilePath     : /micro-base/src/components/base-wordcloud/index.vue
 * @Description  : filename
 * 
 * Copyright (c) 2023 by ${git_name_email}, All Rights Reserved. 
-->
<template>
    <a-card :bordered="false" id="base-wordcloud">
    </a-card>
</template>
    ...
    fetch('https://api.vvhan.com/api/hotlist/wbHot').then(async (res: any) => {
        ...
        unref(chartInstance).setOption({
            series: [{
                ...
                data: result.data.map((v: any, idx: number) => {
                    return Object.assign(v, {
                        value: v.hot.replace('万', '') * 10,
                        name: v.title
                    })
                })
            }]
