 ...
 * @LastEditTime : 2022-04-19 16:28:46
 * @LastEditors  : Eug
...
NProgress.configure({ showSpinner: false, easing: 'linear', speed: 1000,  minimum: 0.2,trickle: false , trickleSpeed: 800 });
...
const routes = [
  ...
  { path: '/:pathMatch(.*)*', component: () => import('../NotFound/index.vue') }
];
