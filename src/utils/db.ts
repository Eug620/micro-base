...
const adapter = new LocalStorage<Data>('micro-base')
...
const BaseData:string | null = localStorage.getItem('micro-base')
if (BaseData !== null) {
    db.data= JSON.parse(BaseData)
}
// const BaseData = JSON.parse(localStorage.getItem('micro-base'))
